              ...
              <tr key={asset.symbol} className="group hover:bg-white/[0.02] transition-colors">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center font-black text-xs text-cyan-400">
                      {asset.symbol[0]}
                    </div>
                    <div>
                ...
                <td className="px-6 py-4 text-white/60 text-sm font-medium">
                ...
                <td className="px-6 py-4">
                  <div className="flex justify-end gap-2">
                    <button 
                      ...
                      className="px-4 py-1.5 rounded-lg bg-white/5 hover:bg-cyan-500 hover:text-black text-xs font-black uppercase tracking-tighter transition-all active:scale-95"
                    >
                      Supply
                    </button>
                    <button 
                      onClick={() => openModal(asset, 'Borrow')}
                      className="px-4 py-1.5 rounded-lg border border-white/10 hover:border-purple-500 hover:text-purple-400 text-xs font-black uppercase tracking-tighter transition-all active:scale-95"
                    >
                      Borrow
                    </button>
                  </div>
